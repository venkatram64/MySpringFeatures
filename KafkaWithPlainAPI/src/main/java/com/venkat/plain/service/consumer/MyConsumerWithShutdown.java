...
public class MyConsumerWithShutdown {
    private static final Logger log = LoggerFactory.getLogger(MyConsumerWithShutdown.class.getClass().getSimpleName());

    private KafkaConsumer<String, String> consumer;
    private String topicName = "my-test-topic";
    private String groupId = "my_test_group_id";

    public MyConsumerWithShutdown(){
    ...
    public static void main(String[] args) {
        MyConsumerWithShutdown myConsumer = new MyConsumerWithShutdown();
        myConsumer.consumer();
