...
public class MyProducerWithKeys {

    private static final Logger log = LoggerFactory.getLogger(MyProducerWithKeys.class.getClass().getSimpleName());
    ...
    public static void main(String[] args) {
        MyProducerWithKeys myProducer = new MyProducerWithKeys();
