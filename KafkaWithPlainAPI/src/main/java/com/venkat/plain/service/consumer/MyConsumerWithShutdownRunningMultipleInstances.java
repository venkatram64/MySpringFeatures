...
public class MyConsumerWithShutdownRunningMultipleInstances {
    private static final Logger log = LoggerFactory.getLogger(MyConsumerWithShutdownRunningMultipleInstances.class.getClass().getSimpleName());

    private KafkaConsumer<String, String> consumer;
    private String topicName = "my-test-topic";
    private String groupId = "my_test_group_id";

    public MyConsumerWithShutdownRunningMultipleInstances(){
    ...
    public static void main(String[] args) {
        MyConsumerWithShutdownRunningMultipleInstances myConsumer = new MyConsumerWithShutdownRunningMultipleInstances();
        myConsumer.consumer();
